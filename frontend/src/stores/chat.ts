...
const SEED_MESSAGES: Record<number, ChatMessage[]> = {
	...
	3: [
		...
		},
		{
			...
			authorName: "산악회장",
			content:
				"이번 달 관악산 정기 산행 일자 확정됐어요. 5월 17일 토요일 09:00 사당역 집결!",
			createdAt: "2026-05-07T11:00:00Z",
		},
		{
			id: 11,
	...
	101: {
		...
		messages: [
			...
			},
			{
				...
				receiverId: 0,
				content:
					"네 안녕하세요! 5월 31일부터 2박은 가능합니다 😊 인원이 몇 분이세요?",
			...
			},
			{
				...
				receiverId: 0,
				content:
					"조식은 별도 1인 2만원입니다. 미리 예약하시면 포함해드릴 수 있어요!",
...
export const useChatStore = defineStore("chat", () => {
	...
	const activeDmThread = computed<DmThread | null>(() =>
		activeDmPartnerId.value !== null
			? (dmThreads.value[activeDmPartnerId.value] ?? null)
			: null,
	);
